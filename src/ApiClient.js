...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://hapi-ofccp-onboarding.herokuapp.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://hapi-ofccp-onboarding.herokuapp.com
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://hapi-ofccp-onboarding.herokuapp.com",
